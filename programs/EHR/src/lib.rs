...
pub mod ehr {
    ...
    pub fn init_doctor_profile(ctx: Context<InitDoctorProfile>,  doctor_name: String, doctor_sex: String, doctor_dob: String, doctor_experience_months: u32, doctor_gc_fee: u128, doctor_licence: bool, doctor_gc_expiry_time: i64) -> Result<()>{
    ...
    pub fn init_technician_profile(ctx: Context<InitTechnicianProfile>, technician_name: String, technician_sex: String, technician_dob: String, technician_experience_months: u32, technician_bloodtest_fee: u128, technician_licence: bool, technician_bloodtest_expiry_time: i64) -> Result<()>{
    ...
    pub fn update_bloodtest_report(ctx: Context<UpdateBloodtestReport>,  white_blood_cells: u128, red_blood_cells: u128, blood_platelets: u128, technician_comments: String) -> Result<()>{
        instructions::update_bloodtest_report::handler(ctx, white_blood_cells, red_blood_cells, blood_platelets, technician_comments)
    }
    pub fn update_gc_report(ctx: Context<UpdateGcReport>, blood_pressure: u32, blood_sugar: u32, temperature: u32, doctor_comments: String) -> Result<()>{
        instructions::update_gc_report::handler(ctx, blood_pressure, blood_sugar, temperature, doctor_comments)
    }
